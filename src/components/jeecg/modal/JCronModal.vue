      ...
      <a-tabs type="card">
        <a-tab-pane key="1" type="card">
          ...
          <a-radio-group v-model="result.second.cronEvery">
            ...
            <a-row>
              <a-radio value="3">特定の秒（複数の選択肢）</a-radio>
        ...
        <a-tab-pane key="2">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.minute.cronEvery">
              ...
              <a-row>
                <a-radio value="3">特定の分（複数の選択肢）</a-radio>
        ...
        <a-tab-pane key="3">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.hour.cronEvery">
              ...
              <a-row>
                <a-radio class="long" value="3">特定の時間（複数の選択肢）</a-radio>
        ...
        <a-tab-pane key="4">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.day.cronEvery">
              ...
              <a-row>
                <a-radio class="long" value="4">特定の曜日（複数の選択肢）</a-radio>
                <a-select style="width:340px;" size="small" mode="multiple" v-model="result.week.specificSpecific">
                  <a-select-option v-for="(val,index) in Array(7)" :key="index" :value="index+1">{{ weekDays[index] }}</a-select-option>
                </a-select>
              </a-row>
              <a-row>
                <a-radio class="long" value="5">特定の日（複数の選択肢）</a-radio>
              ...
              <a-row>
                <a-radio value="6">月の最後の日に</a-radio>
              </a-row>
              <a-row>
                <a-radio value="7">月の最後の営業日に</a-radio>
              </a-row>
              <a-row>
                <a-radio value="8">月の最後の1つ
        ...
        <a-tab-pane key="5">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.month.cronEvery">
              ...
              <a-row>
                <a-radio class="long" value="3">特定の月（複数の選択肢）</a-radio>
        ...
        <a-tab-pane key="6">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.year.cronEvery">
              ...
              <a-row>
                <a-radio class="long" value="3">特定の年（複数の選択肢）</a-radio>
  ...
  export default {
    ...
    data(){
      return {
        ...
        size:'large',
        weekDays:['日','月','火','水','木','金','土'].map(val=>val + '曜日'),
        result: {
          second:{},
          minute:{},
          hour:{},
