    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="番号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'code', validatorRules.code]" placeholder="请输入番号"></a-input>
        </a-form-item>
        ...
        <a-form-item label="店铺id" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'shopId', validatorRules.shopId]" placeholder="请输入店铺id"></a-input>
        </a-form-item>
        <a-form-item label="窗口呼出番号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'windowCode', validatorRules.windowCode]" placeholder="请输入窗口呼出番号"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'code','companyId','shopId','windowCode'))
        })
      },
      close () {
        this.$emit('close');
