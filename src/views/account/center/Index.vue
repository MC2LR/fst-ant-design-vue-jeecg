      ...
      <a-col :md="24" :lg="7">
        <a-card :bordered="false">
          <div class="account-center-avatarHolder">
            ...
            <div class="bio">海は百川を飲み,その勢いは大いにある</div>
          </div>
          <div class="account-center-detail">
            <p>
              <i class="title"></i>インタラクティブ・スペシャリスト
            </p>
            <p>
              <i class="group"></i>蟻金服−△△△事業群−△△プラットフォーム部−△△技術部−UED
            </p>
            <p>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        tags: ['なかなかアイデアがあります', '設計に専念する', '辛い~', '長い足', '川の妹', '海納百川'],
