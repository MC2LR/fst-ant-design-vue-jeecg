...
<script>
  ...
  export default {
    ...
    data() {
      return {
        description: this.$t('system_Menumanage'),
        // 表头
        columns: [
    {
      title:this.$t('system_Menuname') ,
      dataIndex: 'name',
      key: 'name'
    }, {
      title:this.$t('system_Menutype'),
      dataIndex: 'menuType',
      key: 'menuType',
      ...
      title: this.$t('system_MenuPermissionCode'),
      dataIndex: 'perms',
      key: 'permissionCode',
    },*/{
      title: this.$t('system_Menuicon'),
      dataIndex: 'icon',
      key: 'icon'
    },
    {
      title: this.$t('system_MenuComponent'),
      dataIndex: 'component',
      key: 'component',
      scopedSlots: { customRender: 'component' }
    },
    {
      title: this.$t('system_MenuUrl'),
      dataIndex: 'url',
      key: 'url',
      scopedSlots: { customRender: 'url' }
    },
    {
      title: this.$t('system_Menuorderby'),
      dataIndex: 'sortNo',
      key: 'sortNo'
    },
    {
    ...
    methods: {
      ...
      handleAddSub(record) {
        this.$refs.modalForm.title = this.$t('system_MenuAddsubmenu');
