    ...
    <div
      ...
      <div class="table-page-search-wrapper">
        <a-form @keyup.enter.native="searchQuery">
          <a-row :gutter="12">
            <a-col :md="8" :sm="8">
              <a-form-item :label="$t('system_MenuRulename')" :labelCol="{span: 8}" :wrapperCol="{span: 14, offset: 1}">
                <a-input :placeholder="$t('system_MenuRuleAddMsg')" v-model="queryParam.ruleName"></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="8">
              <a-form-item :label="$t('system_MenuRuleValue')" :labelCol="{span: 8}" :wrapperCol="{span: 14, offset: 1}">
                <a-input :placeholder="$t('system_MenuRuleValueMsg')" v-model="queryParam.ruleValue"></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="7" :sm="8">
  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
    {
      title: this.$t('system_MenuRulename'),
      dataIndex: 'ruleName',
      key: 'ruleName'
    },
    {
      title: this.$t('system_Menufield'),
      dataIndex: 'ruleColumn',
      key: 'ruleColumn'
    },
    {
      title: this.$t('system_MenuRuleValue'),
      dataIndex: 'ruleValue',
      key: 'ruleValue'
    },
    {
