<template>
  <div class="home">
    ...
    <a-divider> 正常だ </a-divider>

    <a-card>

      <trend flag="up" style="margin-right: 16px;">
        <span slot="term">賃金</span>
        5%
      </trend>
      <trend flag="up" style="margin-right: 16px;">
        <span slot="term">仕事量</span>
        50%
      </trend>
      <trend flag="down">
        <span slot="term">体の状態</span>
        50%
      </trend>

    </a-card>

    <a-divider> 色を反転 </a-divider>
