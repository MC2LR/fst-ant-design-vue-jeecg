  ...
  <div class="main">
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
      <a-tabs
        ...
        <a-tab-pane key="tab1" :tab="$t('login_title')">
          <a-form-item>
            <a-input
              size="large"
      ...
      <!-- <a-form-item>
        <a-checkbox v-decorator="['rememberMe', {initialValue: true, valuePropName: 'checked'}]" >{{$t('auto_login')}}</a-checkbox>
  ...
  export default {
    ...
    data () {
      return {
        ...
        // validatorRules:{
        //   username:{rules: [{ required: true, message: this.$t('account'),validator: 'click'}]},
        //   password:{rules: [{ required: true, message: this.$t('password'),validator: 'click'}]},
        //   mobile:{rules: [{validator:this.validateMobile}]},
        //   captcha:{rule: [{ required: true, message: this.$t('enter_code')}]},
        //   inputCode:{rules: [{ required: true, message: this.$t('enter_code')},{validator: this.validateInputCode}]}
        // },
        verifiedCode:"",
        inputCodeContent:"",
        inputCodeNull:true,
    ...
    methods: {
      ...
      loginSuccess () {
        ...
        this.$notification.success({
          ...
          description: `${timeFix()}，`+this.$t('comeback'),
        });
      },
      cmsFailed(err){
