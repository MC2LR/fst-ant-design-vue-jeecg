<template>
  <a-card>
    <draggable @end="end" :options="{animation: 300}" v-model="dataSource" style="display: inline-block">
      ...
      <a-button @click="sureChange" type="primary" style="margin-top: 115px">を選択します</a-button>
    </draggable>
    <br/>
    <a-row>
      <a-col :span="12">
        <p>前のjsonデータをドラッグします：</p>
...
<script>
  ...
  export default {
    ...
    methods:{
        ...
        console.log("ドラッグする前の位置"+evt.oldIndex);
        console.log("ドラッグした後の位置"+evt.newIndex);
      },
      sureChange(){
