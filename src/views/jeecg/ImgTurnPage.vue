<template>
  <a-card title="ツリー構造の画像をページをめくって表示します。" style="min-width: 800px;overflow-x:auto ">
    <a-row>
      <!-- 左のファイルツリー -->
      <a-col :span="5">
        <a-tree
      ...
      <a-col :span="19">
        <a-row style="margin-top: 10px">
          <a-col :span="24" style="padding-left: 2%;margin-bottom: 10px">
            <a-button @click="prev" type="primary"><a-icon type="left" />前のページ</a-button>
            <a-button @click="next" type="primary" style="margin-left: 8px">次のページ<a-icon type="right" /></a-button>
