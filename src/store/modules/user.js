    ...
    GetPermissionList({ commit }) {
      return new Promise((resolve, reject) => {
        ...
        queryPermissionsByUser(params).then(response => {
          const menuData =[]
          response.result.menu.forEach(element => {
            if(element.component!="wang_puhan/call" && element.component!="ma_ruilin/Teller"){
              menuData.push(element);
            }
          });
          
          console.log("这是menu测试");
